...
def retrieve_cfg(args, use_rlg_config=False):
    if args.task == "BlockAssemblyGraspSim":
        return os.path.join(args.logdir, "allegro_hand_block_assembly_grasp_sim/{}/{}".format(args.algo, args.algo)), "cfg/lego/config.yaml", "cfg/allegro_hand_block_assembly_grasp_sim.yaml"
    elif args.task == "BlockAssemblyGrasp":
        return os.path.join(args.logdir, "allegro_hand_block_assembly_grasp/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_block_assembly_grasp.yaml"
    elif args.task == "BlockAssemblyGUI":
        return os.path.join(args.logdir, "allegro_hand_block_assembly_gui/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_block_assembly_gui.yaml"
    elif args.task == "BlockAssemblyInsertSim":
        return os.path.join(args.logdir, "allegro_hand_block_assembly_insert_sim/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_block_assembly_insert_sim.yaml"
    elif args.task == "BlockAssemblyInsert":
        return os.path.join(args.logdir, "allegro_hand_block_assembly_insert/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_block_assembly_insert.yaml"
    elif args.task == "BlockAssemblyOrientOnce":
        return os.path.join(args.logdir, "allegro_hand_block_assembly_orient_once/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_block_assembly_orient_once.yaml"
    elif args.task == "BlockAssemblyOrient":
    ...
    elif args.task == "InspireBlockAssemblySearch":
        return os.path.join(args.logdir, "realman_inspire_block_assembly_search/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/realman_inspire_block_assembly_search.yaml"
    elif args.task == "InspireGraspBlock":
        ...
        return os.path.join(args.logdir, "allegro_hand_tool_positioning_chain_tstar/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_tool_positioning_chain_tstar.yaml"
    elif args.task == "ToolPositioningChain":
        return os.path.join(args.logdir, "allegro_hand_tool_positioning_chain/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_tool_positioning_chain.yaml"
    elif args.task == "ToolPositioningGrasp":
        return os.path.join(args.logdir, "allegro_hand_tool_positioning_grasp/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_tool_positioning_grasp.yaml"
    elif args.task == "ToolPositioningOrient":
        return os.path.join(args.logdir, "allegro_hand_tool_positioning_orient/{}/{}".format(args.algo, args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/allegro_hand_tool_positioning_orient.yaml"
    else:
        warn_task_name()
...
def get_args(benchmark=False, use_rlg_config=False):
    custom_parameters = [
        ...
        {"name": "--before_checkpoint", "type": str, "default": "",
            "help": "Only for policy sequencing"},
        {"name": "--after_checkpoint", "type": str, "default": "",
            "help": "Only for policy sequencing"},
...
def get_args_scripts(task, num_envs, algo, benchmark=False, use_rlg_config=False, play=False):
    custom_parameters = [
        {"name": "--test", "action": "store_true", "default": False,
            "help": "Run trained policy, no training"},
        {"name": "--play", "action": "store_true", "default": False,
